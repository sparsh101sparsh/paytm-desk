# DESK Demo Script (90 Seconds on Stage)
...
> 
> *This is **DESK** — an autonomous Paytm Intelligence teammate that doesn't answer questions; it gets the job done.*
> 
...
2. **Narration**:
   ...
   > *Watch the timeline when I click **Run DESK**."*
3. **Action**: Click `Run DESK`.
4. **Narration**:
...
2. **Narration**:
   ...
   > *A naive AI chatbot might guess or blindly process money. Watch DESK."*
3. **Action**: Click `Run DESK`.
4. **Narration**:
...
4. **Narration**:
   ...
   > *Instead, DESK synthesized a 6-line operational brief directly into the Risk Ops queue with exact verification checks and recommendations.*
